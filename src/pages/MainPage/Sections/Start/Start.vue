<template>
  <section ref="wrapper" class="start__wrapper">
    ...
    <base-button :click-handler="clickHandler" :text="$t('mainPage.start.startProject')" />
    <div class="start__image start-image">
      <img src="../../../../assets/img/MainPage/Start.png" alt="Start project" />
      <div class="start-image__done">
        <ul>
          <li>
            <q-icon name="fa fa-star" class="start-image__star" />
      ...
      <dots class="start-image__dots start-image__dots--red" color="#FF5C00" />
    ...
    <div v-for="point in pointsPosition" :key="point.id" :class="['start__babble', `start__babble--${point.color}`]"
      :style="{
        top: `${point.top}px`,
